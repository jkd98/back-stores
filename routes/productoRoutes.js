...
import { validDeleteProduct, validEditProduct, validFilterProducts, validGetOneProduct, validNwProduct } from '../validators/productoValidator.js';
...
router.get('/:codigo',validGetOneProduct, manejarErrores, checkAuth, getProductByCode);
